...
import { SafeAreaView, StyleSheet, Text, TouchableHighlight, View, Alert,Image, Touchable, TouchableOpacity} from 'react-native';
    ...
    style={{flex:1}}>
      ...
      <View style={styles.box4}>
        ...
        <View style={{flex:1,alignItems:'center',justifyContent:'space-evenly',}}>
          <Text style={{fontSize:30,color:'white',fontWeight:'bold'}}>Get Started</Text>
          <Text style={{color:'#f1f1f1'}}>Choose one?</Text>
        </View>
        <View style={{flex:2}}>
          <TouchableOpacity underlayColor="white" onPress={(e)=>{ handlebutton("Customer")}}>
            <View style={styles.cusbutton}>
              <Text style={styles.cusbuttonText}>I am a Customer</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity underlayColor="white" onPress={(e)=>{ handlebutton("Shop Owner")}}>
...
const styles = StyleSheet.create({
  ...
  box4:{
    flex: 5, backgroundColor: '#8A57E4',alignItems:'center',justifyContent:'center'
  },
  cusbutton: {
    marginBottom: 30,
    width: 260,
